 ...
 */
public class BeiLiManager_Se extends BeiLiServer {
	private static BeiLiManager_Se singleInstance = null;
	...
	public static BeiLiManager_Se getSingleInstance(){
		if (singleInstance == null) {
			synchronized (BeiLiManager_Se.class) {
				if (singleInstance == null) {
					singleInstance = new BeiLiManager_Se();
				}
			}
		}
